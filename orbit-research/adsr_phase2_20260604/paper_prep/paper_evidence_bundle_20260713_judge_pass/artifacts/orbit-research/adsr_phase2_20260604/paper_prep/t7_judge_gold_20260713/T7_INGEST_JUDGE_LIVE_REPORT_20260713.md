...
evidence: `paper_prep/paper_evidence_bundle_20260713_judge_pass/INDEX.md`, `paper_prep/paper_evidence_bundle_20260713_judge_pass.tar.gz`
...
- Live watcher: local tmux `adsr_w2_live_gpu_watch_20260713`, pane PID `not-running`; last state `WAITING`.
