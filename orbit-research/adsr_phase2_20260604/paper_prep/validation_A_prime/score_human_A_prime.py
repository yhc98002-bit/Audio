...
def main() -> int:
    ...
    parser.add_argument("--admin", type=Path, default=package / "A_PRIME_PRIMARY_ADMIN.csv")
    parser.add_argument("--ratings", type=Path, default=package / "A_PRIME_PRIMARY_RATINGS.csv")
    parser.add_argument("--out", type=Path, default=ROOT / "paper_prep/validation_A_prime/A_PRIME_HUMAN_GATE_REPORT_20260709.md")
